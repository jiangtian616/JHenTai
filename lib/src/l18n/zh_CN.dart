...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': '本地',
      'scanningLocalGallerys': '正在扫描本地画廊',
      'scanCompleted': '本地画廊扫描完成',
      ...
      'noHistoryVersionsToDelete': '没有历史版本需要删除',
      'scanningHistoryVersions': '正在扫描历史版本',
      'deepScan': '深度扫描',
      'deepScanning': '正在深度扫描远程画廊...',
      'deepScanCompleted': '深度扫描完成，发现 \$n 个新关联',
      'deepScanNoNewLinks': '深度扫描完成，未发现新的版本关联',
      'noGalleriesToDeepScan': '没有需要深度扫描的画廊',
      'versions': '个版本',
      'ungroupedGalleriesHint': '个未分组画廊，点击深度扫描检查',
      'linkedVersion': '已关联',
      'retryFailed': '重试失败部分',
      'failedGallerys': '失败画廊',
      'useHistoryScanResult': '历史扫描结果',
      'newDeepScan': '全新扫描',
      'deepScanChoiceHint': '存在24小时内的历史扫描结果。',
      'failedCount': '个失败',
      'selectAll': '全选',
      'deselectAll': '取消全选',
      'selected': '已选',
      ...
      'scanFailed': '扫描失败',
      'items': '项',
      'batchDownloadInProgress': '批量下载进行中，请稍候',
      'noNewFavoritesToDownload': '没有新的收藏需要下载',
      'batchDownloadCompleted': '批量下载完成',
      'loadingAllFavorites': '正在加载所有收藏',
      'batchDownloading': '正在批量下载',
      'batchDownloadRetryExhausted': '重试次数已用尽',
      'batchDownloadLoadingFailed': '加载收藏失败，已记录进度',
      'batchDownloadFailureCountdown': '下载失败，\$time 内重新点击可继续',
      'interruptWait': '中断等待',
      'batchDownloadResumed': '继续上次中断的下载',
      'batchDownloadWaitInterrupted': '已中断等待，下次将重新开始',
      'delete': '删除',
      'deleteTask': '仅删除任务',
