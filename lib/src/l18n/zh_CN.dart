...
class zh_CN {
  static Map<String, String> keys() {
    return {
      ...
      'resetSuccess': '重置成功',
      'imageConnectionTimeout': '图片连接超时',
      'imageConnectionTimeoutHint': '图片加载连接建立超时时间，长按重置为默认值',
      'imageMaxConnectionsPerHost': '图片最大连接数',
      'imageMaxConnectionsPerHostHint': '每个主机的最大并发连接数，防止连接池污染，长按重置为默认值',
      'imageIdleTimeout': '图片空闲连接超时',
      'imageIdleTimeoutHint': '空闲连接自动关闭时间，定期清理有问题的连接，长按重置为默认值',
