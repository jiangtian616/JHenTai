...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': 'Local',
      'scanCompleted': 'Verificação de galerias locais concluída',
      'deleteHistoryVersions': 'Excluir Versões Anteriores',
      'deleteHistoryVersionsHint': 'Agrupa por cadeia de versão (oldVersionGalleryUrl), não por nome. Use verificação profunda para encontrar links remotos.',
      'deletingHistoryVersions': 'Excluindo versões anteriores',
      'deletingHistoryVersionsInProgress': 'Excluindo versões anteriores, aguarde',
      'deleteHistoryVersionsCompleted': 'Exclusão de versões anteriores concluída',
      'noHistoryVersionsToDelete': 'Nenhuma versão anterior para excluir',
      'scanningHistoryVersions': 'Verificando versões anteriores',
      'deepScan': 'Verificação Profunda',
      'deepScanning': 'Verificação profunda de galerias remotas...',
      'deepScanCompleted': 'Verificação profunda concluída, \$n novos links encontrados',
      'deepScanNoNewLinks': 'Verificação profunda concluída, nenhum novo link de versão encontrado',
      'noGalleriesToDeepScan': 'Nenhuma galeria para verificação profunda',
      'versions': 'versões',
      'ungroupedGalleriesHint': 'galerias não agrupadas, toque em verificação profunda para verificar',
      'linkedVersion': 'vinculado',
      'retryFailed': 'Repetir Falhas',
      'failedGallerys': 'Galerias Falhadas',
      'useHistoryScanResult': 'Usar Resultado Anterior',
      'newDeepScan': 'Nova Verificação',
      'deepScanChoiceHint': 'Um resultado de verificação anterior de até 24 horas está disponível.',
      'failedCount': 'falhas',
      ...
      'batchDownloadInProgress': 'Download em lote em andamento, aguarde',
      'noNewFavoritesToDownload': 'Nenhum novo favorito para baixar',
      'batchDownloadCompleted': 'Download em lote concluído',
      'loadingAllFavorites': 'Carregando todos os favoritos',
      'batchDownloading': 'Download em lote',
      'batchDownloadRetryExhausted': 'Tentativas esgotadas',
      'batchDownloadLoadingFailed': 'Falha ao carregar favoritos, progresso salvo',
      'batchDownloadFailureCountdown': 'Download falhou, clique novamente em \$time para continuar',
      'interruptWait': 'Interromper Espera',
      'batchDownloadResumed': 'Retomando download interrompido',
      'batchDownloadWaitInterrupted': 'Espera interrompida, começará do zero na próxima vez',
      ...
      'quickSearchConfig': 'Quick Search Config',
