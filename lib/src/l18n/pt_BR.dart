...
class pt_BR {
  static Map<String, String> keys() {
    return {
      ...
      'imageConnectionTimeout': 'Tempo limite de conexão da imagem',
      'imageConnectionTimeoutHint': 'Tempo limite para estabelecer conexão de carregamento de imagem, pressione e segure para redefinir',
      'imageMaxConnectionsPerHost': 'Máx. conexões da imagem',
      'imageMaxConnectionsPerHostHint': 'Máx. conexões simultâneas por host para prevenir contaminação do pool, pressione e segure para redefinir',
      'imageIdleTimeout': 'Tempo limite de conexão ociosa',
      'imageIdleTimeoutHint': 'Tempo para fechar automaticamente conexões ociosas e limpar conexões problemáticas, pressione e segure para redefinir',
