...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'networkError': "Network Error, Long Press to Reload",
      ...
      'parsePageFailed': "Parse Page Failed, Long Press to Retry",
      'parseURLFailed': "Parse URL Failed, Long Press to Retry",
      'loading': "Loading",
      'paused': 'Paused',
