...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': 'Local',
      'scanningLocalGallerys': 'Scanning local galleries',
      'scanCompleted': 'Local gallery scan completed',
      ...
      'deleteHistoryVersionsCompleted': 'Delete history versions completed',
      'noHistoryVersionsToDelete': 'No history versions to delete',
      'scanningHistoryVersions': 'Scanning history versions',
      'deepScan': 'Deep Scan',
      'deepScanning': 'Deep scanning remote galleries...',
      'deepScanCompleted': 'Deep scan completed, found \$n new links',
      'deepScanNoNewLinks': 'Deep scan completed, no new version links found',
      'noGalleriesToDeepScan': 'No galleries to deep scan',
      'versions': 'versions',
      'ungroupedGalleriesHint': 'ungrouped galleries, tap deep scan to check',
      'linkedVersion': 'linked',
      'retryFailed': 'Retry Failed',
      'failedGallerys': 'Failed Galleries',
      'useHistoryScanResult': 'Use Previous Scan Result',
      'newDeepScan': 'New Deep Scan',
      'deepScanChoiceHint': 'A previous scan result from within 24 hours is available.',
      'failedCount': 'failed',
      ...
      'items': 'items',
      'batchDownloadInProgress': 'Batch download in progress, please wait',
      'noNewFavoritesToDownload': 'No new favorites to download',
      'batchDownloadCompleted': 'Batch download completed',
      'loadingAllFavorites': 'Loading all favorites',
      'batchDownloading': 'Batch downloading',
      'batchDownloadRetryExhausted': 'Retries exhausted',
      'batchDownloadLoadingFailed': 'Loading favorites failed, progress saved',
      'batchDownloadFailureCountdown':
          'Download failed, retry within \$time to continue',
      'interruptWait': 'Interrupt Wait',
      'batchDownloadResumed': 'Resuming interrupted download',
      'batchDownloadWaitInterrupted':
          'Wait interrupted, will start fresh next time',
