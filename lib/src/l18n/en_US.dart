...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'enableAria2Push': 'Enable Push Archive to aria2',
      'enableAria2PushHint': 'Push archive link to aria2 instead of downloading in app',
      'aria2Settings': 'aria2 Settings',
      'aria2RpcUrl': 'RPC URL',
      'aria2RpcUrlHint': 'http://127.0.0.1:6800/jsonrpc',
      ...
      'aria2ConnectionFailed': 'aria2 connection failed',
      'pushArchiveToAria2': 'Push Archive to aria2',
