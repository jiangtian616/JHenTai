...
class en_US {
  static Map<String, String> keys() {
    return {
      ...
      'imageConnectionTimeout': 'Image Connection Timeout',
      'imageConnectionTimeoutHint': 'Timeout for establishing image loading connection, long press to reset',
      'imageMaxConnectionsPerHost': 'Image Max Connections',
      'imageMaxConnectionsPerHostHint': 'Max concurrent connections per host to prevent pool pollution, long press to reset',
      'imageIdleTimeout': 'Image Idle Timeout',
      'imageIdleTimeoutHint': 'Auto close idle connections time to clean bad connections, long press to reset',
