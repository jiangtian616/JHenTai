...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'resetSuccess': '重置成功',
      'imageConnectionTimeout': '圖片連線超時',
      'imageConnectionTimeoutHint': '圖片載入連線建立超時時間，長按重置為預設值',
      'imageMaxConnectionsPerHost': '圖片最大連線數',
      'imageMaxConnectionsPerHostHint': '每個主機的最大並發連線數，防止連線池污染，長按重置為預設值',
      'imageIdleTimeout': '圖片閒置連線超時',
      'imageIdleTimeoutHint': '閒置連線自動關閉時間，定期清理有問題的連線，長按重置為預設值',
