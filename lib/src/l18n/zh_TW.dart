...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': '本機',
      'scanCompleted': '本機畫廊掃描完成',
      'deleteHistoryVersions': '刪除歷史版本',
      'deleteHistoryVersionsHint': '按版本鏈（oldVersionGalleryUrl）分組，而非按名稱分組。可使用深度掃描查找遠端關聯。',
      'deletingHistoryVersions': '正在刪除歷史版本',
      'deletingHistoryVersionsInProgress': '正在刪除歷史版本，請稍候',
      'deleteHistoryVersionsCompleted': '刪除歷史版本完成',
      'noHistoryVersionsToDelete': '沒有歷史版本需要刪除',
      'scanningHistoryVersions': '正在掃描歷史版本',
      'deepScan': '深度掃描',
      'deepScanning': '正在深度掃描遠端畫廊...',
      'deepScanCompleted': '深度掃描完成，發現 \$n 個新關聯',
      'deepScanNoNewLinks': '深度掃描完成，未發現新的版本關聯',
      'noGalleriesToDeepScan': '沒有畫廊需要深度掃描',
      'versions': '個版本',
      'ungroupedGalleriesHint': '個未分組畫廊，點擊深度掃描檢查',
      'linkedVersion': '已關聯',
      'retryFailed': '重試失敗部分',
      'failedGallerys': '失敗畫廊',
      'useHistoryScanResult': '歷史掃描結果',
      'newDeepScan': '全新掃描',
      'deepScanChoiceHint': '存在24小時內的歷史掃描結果。',
      'failedCount': '個失敗',
      'selectAll': '全選',
      'deselectAll': '取消全選',
      'selected': '已選',
      ...
      'pages': '頁',
      'scanFailed': '掃描失敗',
      'batchDownloadInProgress': '批量下載進行中，請稍候',
      'noNewFavoritesToDownload': '沒有新的收藏需要下載',
      'batchDownloadCompleted': '批量下載完成',
      'loadingAllFavorites': '正在載入所有收藏',
      'batchDownloading': '正在批量下載',
      'batchDownloadRetryExhausted': '重試次數已用盡',
      'batchDownloadLoadingFailed': '載入收藏失敗，已記錄進度',
      'batchDownloadFailureCountdown': '下載失敗，\$time 內重新點擊可繼續',
      'interruptWait': '中斷等待',
      'batchDownloadResumed': '繼續上次中斷的下載',
      'batchDownloadWaitInterrupted': '已中斷等待，下次將重新開始',
      'delete': '刪除',
      'deleteTask': '僅刪除任務',
