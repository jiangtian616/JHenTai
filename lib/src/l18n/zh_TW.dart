...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'tapZoneStyle': '點擊區域樣式',
      'tapZoneStyleHint': '自訂閱讀頁的點擊翻頁區域',
      'tapZonePreset': '預設',
      'tapZonePresetClassic': '經典三分',
      'tapZonePresetVertical': '上下翻頁',
      'tapZoneRatio': '區域大小',
      'tapZoneAction': '點擊區域動作',
      'tapZoneActionNone': '無',
      ...
      'tapZoneTopRowRatio': '頂行高度',
      'tapZoneMiddleRowRatio': '中行高度',
      'tapZoneBottomRowRatio': '底行高度',
      'tapZonePreview': '預覽',
      'tapZoneGuideHint': '點擊任意處關閉引導，可在 設定→閱讀 中配置區域',
...
favnote：配對收藏備註
      ...
      'archiveBotNotConfigured': '歸檔機器人未配置，前往設定？',
      'getBotCostFailed': '獲取Bot花費失敗',
      'archiveBotShort': 'Bot',
