...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'getGalleryFavoriteInfoFailed': '獲取畫廊收藏信息失敗',
      'favoriteNoteSlotFullHint': '收藏備注已滿，無法添加新備注',
      'ratingSuccess': '評分成功',
      'ratingFailed': '評分失敗',
      ...
      'zhTagSearchOrderOptimization': '標簽補全排序規則',
      'zhTagSearchOrderOptimizationHint': '默認智能排序，啓用後按畫廊使用頻次排序',
      'themeMode': '主題模式',
      'dark': '黑暗',
      'light': '明亮',
      'followSystem': '跟隨系統',
      ...
      'searchBehaviour': '搜索選項繼承',
      'inheritAll': '繼承全部',
      'inheritAllHint': '搜索時使用上壹次搜索選項',
      'inheritPartially': '繼承部分',
      'inheritPartiallyHint': '搜索時使用上壹次搜索選項（除開種類和語言）',
      'none': '無',
      'noneHint': '搜索時使用新的初始搜索選項',
      ...
      'clearSuccess': '清除成功',
      'superResolution': '圖片超分辨率',
      'stopSuperResolution': '停止圖片超分辨率',
      'deleteSuperResolvedImage': '刪除圖片超分辨率後的圖片',
      ...
      'enableImageMaxKilobytes': '開啓圖片壓縮',
      'imageMaxKilobytes': '圖片大小限制',
      'imageMaxKilobytesHint': '超過此大小的圖片將會被壓縮',
      'image': '圖片',
      'screen': '螢幕',
      'preloadDistanceInOnlineMode': '預載距離(在線模式)',
      'preloadDistanceInLocalMode': '预载距离(本地模式)',
      'ScreenHeight': '屏幕',
      'preloadPageCount': '預載圖片數量(在線模式)',
      'preloadPageCountInLocalMode': '預載圖片數量(本地模式)',
      ...
      'peakHoursHint': '高峰段下載原圖需要耗費GP，由于你的GP不足，下載已自動停止。',
      'oldGalleryHint': '部分畫廊下載原圖需要耗費GP，由于你的GP不足，下載已自動停止。',
      'exceedLimitHint': '圖片配額已耗盡，由于你的GP不足，下載已自動停止。',
...
favnote：匹配收藏備注
      ...
      'downloadAllGallerysOfSamePriorityHint': '默認情況下逐優先級下載畫廊，且每個優先級下只會同時下載一個畫廊',
      ...
      'archiveDownloadIsolateCountHint': '所有任務活躍線程數之和若超過10將導致下載失敗',
      'manageArchiveDownloadConcurrency': '控制歸檔下載並發數',
      'manageArchiveDownloadConcurrencyHint': '在有足夠的線程下載之前，歸檔任務會保持等待狀態',
