...
class zh_TW {
  static Map<String, String> keys() {
    return {
      ...
      'downloadFromRemoteDevice': '來自 {device} 的遠端下載',
      'resumeDownload': '繼續下載',
      'pauseDownload': '暫停下載',
      ...
      'readerPerformanceExperiments': '實驗性閱讀效能',
      'readerEngine2': 'Reader Engine 2.0',
      'readerEngine2Hint': '根據目前可見頁面與捲動方向，優先解析附近頁面',
      'performanceGovernor': 'Performance Governor',
      'performanceGovernorHint': '監測影格耗時，在持續掉幀時自動降低預取範圍與解析並行數',
      'progressiveImagePipeline': '漸進式圖片管線',
      'progressiveImagePipelineHint': '先顯示畫廊縮圖，再替換為原圖，減少空白等待',
      ...
      'enableSmartCache': "智慧快取",
      'enableSmartCacheHint': "開啟後按保留時間長期快取看過的頁面和圖片；關閉後僅保留短期快取",
      'smartCacheRetention': "快取保留時間",
      'smartCacheRetentionHint': "超過此時間的快取會被自動清除",
      'smartCacheMaxSize': "快取空間上限",
      'moveCacheToServer': '將快取移到伺服器',
      'moveCacheToServerHint': '將本機快取上傳到已連線的區域網路伺服器',
      'moveCacheToServerDisabledHint': '需先連線到區域網路伺服器',
      'moveCacheToServerDone': '已向伺服器上傳 {count} 個快取檔案',
      'smartCacheMaxSizeHint': "超過上限後會自動清理快取",
      'smartCacheEvictPolicy': "清理策略",
      'smartCacheEvictPolicyHint': "達到上限時優先刪除的快取",
      'smartCacheEvictByAddedDate': "按加入日期",
      'smartCacheEvictByUsageFrequency': "按使用頻率",
      'unlimited': "不限",
      'cacheSize': "目前快取大小",
      'lanSharing': '區域網路共享',
      'lanGalleryList': '區域網路圖庫',
      'lanLocalTabAsLan': '下載頁「本地」目錄顯示區域網路圖庫',
      'lanLocalTabAsLanHint': '開啟後，下載頁的「本地」標籤顯示已連接信任裝置上的已下載圖庫',
      'lanStayResident': '常駐背景（mac/Linux/Windows）',
      'lanStayResidentHint': '開啟後關閉視窗不退出，應用在背景繼續執行（區域網路共享保持連線），從系統托盤恢復',
      'lanActAsServer': '充當區域網路伺服器',
      'lanActAsServerHint': '僅桌面端可用：發布本裝置的區域網路服務端。行動端只作為前台客戶端。',
      'lanServerMode': '伺服器模式',
      'lanActiveBroadcast': '主動廣播',
      'lanActiveBroadcastHint': '發現新裝置時自動傳送配對請求，由對方決定是否接受',
      'lanServerModeHint': '本裝置作為儲存/快取：連接裝置瀏覽的圖片在這裡下載並快取，連接裝置自身快取佔用極小',
      'lanPreferredServer': '首選伺服器',
      'lanNoPreferredServer': '自動：使用任一已連接的受信任伺服器',
      'lanResidentShow': '顯示主視窗',
      'lanResidentQuit': '退出',
      ...
      'lanDownloadToDevice': '下載到該裝置',
      'lanDownloadToDeviceSent': '已傳送下載請求到該裝置',
      'lanDownloadToDeviceFailed': '下載請求傳送失敗',
      'lanUnknownDevice': '未知裝置',
      'lanSharingHint': '配對並自動重新連線已信任的裝置',
      'experimentalFeatures': '實驗性功能',
      'lanSharingExperimentalHint': '允許尋找、配對並連線同一區域網路內的裝置',
      'lanFindAndPairDevices': '尋找與配對裝置',
      'lanFindAndPairDevicesHint': '查看附近裝置，並決定是否信任',
      'lanSharingDisabled': '區域網路共享尚未開啟',
      'lanSharingDisabledHint': '請先在進階設定的實驗性功能中開啟此功能。',
      'lanSharingStartFailed': '區域網路服務啟動失敗，功能未啟用，請檢查系統網路權限或日誌',
      'lanLocalDevice': '本機裝置',
      'lanTrafficStats': '傳輸流量',
      'lanTrafficTotal': '合計',
      'lanTrafficSent': '已傳送',
      'lanTrafficReceived': '已接收',
      'lanTrafficCurrentRunHint': '統計本次執行期間的區域網路共享資料',
      'lanDeviceId': '裝置 ID',
      'lanEditDeviceName': '編輯裝置名稱',
      'lanDeviceNameRequired': '裝置名稱不能為空',
      'lanDeviceNameTooLong': '裝置名稱不能超過 128 個字元',
      'lanTrustReady': '裝置信任身分已準備',
      'lanTrustReadyHint': '自動重新連線憑據儲存在系統安全儲存空間中。',
      'lanTrustedDevices': '已信任裝置',
      'lanNoTrustedDevices': '暫無已信任裝置',
      'lanNoTrustedDevicesHint': '完成首次身分驗證與配對後，裝置會顯示在這裡。',
      'lanNearbyDevices': '附近裝置',
      'lanIncomingPairingRequests': '配對請求',
      'lanNoIncomingPairingRequests': '暫無待處理的配對請求',
      'lanIncomingPairingRequestHint': '這台裝置希望與你配對，請核對身分後決定是否信任',
      'lanSearchingDevices': '正在尋找裝置…',
      'lanSearchingDevicesHint': '請保持另一台裝置的區域網路共享功能開啟',
      'lanReviewDevice': '查看',
      'lanPairingWaiting': '等待對方確認…',
      'lanTrustDeviceQuestion': '是否信任 @name？',
      'lanTrustDeviceWarning': '僅信任你認識的裝置。信任後，對方可以存取下方勾選的內容。',
      'lanDoNotTrust': '不信任',
      'lanTrustAndPair': '信任並配對',
      'lanTrustGranted': '裝置已信任',
      'lanPairingFailed': '對方拒絕了請求，或配對失敗，請確認裝置仍在線上',
      'lanAutoConnect': '自動重新連線',
      'lanAutoConnectHint': '再次發現這台可信裝置時直接連線，無需重新配對',
      'lanFingerprint': '身分指紋',
      'lanLastSeen': '最後發現',
      'lanPermissions': '授權範圍',
      'lanRevokeTrust': '撤銷信任',
      'lanRevokeTrustHint': '確定撤銷對 @name 的信任嗎？此後兩台裝置必須重新配對。',
      'lanConnection_offline': '離線',
      'lanConnection_discovered': '已發現',
      'lanConnection_connecting': '正在連線…',
      'lanConnection_connected': '已連線',
      'lanConnection_failed': '連線失敗',
      'lanConnection_identityMismatch': '裝置身分已變更',
      'lanPermission_downloads': '已下載內容',
      ...
      'inferenceBackend': '推理後端',
      'inferenceRefresh': '重新整理',
      'inferenceModeSection': '模式',
      'inferenceManualSection': '手動指定後端',
      'inferenceDetectionSection': '偵測結果',
      'inferenceModelSection': '模型接入狀態',
      'inferenceModeAuto': '自動偵測',
      'inferenceModeManual': '手動指定',
      'inferenceModeCpu': '強制 CPU',
      'inferencePreferredBackend': '首選後端',
      'inferenceDetectedDevice': '偵測到的裝置',
      'inferenceDeviceNotDetected': '未偵測（接入模型後填入）',
      'inferenceDomainOcr': '圖片翻譯（OCR）',
      'inferenceDomainSuperResolution': '影像超分',
      ...
      'inferenceEngineSuperResolution': '圖片上採樣',
      'inferenceModelReady': '已就緒',
      'inferenceModelNotIntegrated': '推理尚未就緒，請在推理設定查看具體狀態',
      'inferenceOcrModel': 'PP-OCRv6 small 多語言 OCR',
      'inferenceOcrLanguageAuto': '自動識別中文、日文、英文等 50 種語言',
      'inferenceSuperResolutionModel': '超分模型（Real-ESRGAN）',
      'inferenceModelNotDownloaded': '未下載',
      'inferenceModelValidating': '正在校驗模型完整性',
      'inferenceModelVerified': '模型已下載並通過完整性校驗',
      'inferenceModelInvalid': '模型損壞或校驗失敗，請重新下載',
      'inferenceSessionStatus': 'Session 狀態',
      'inferenceSessionBackendUnavailable': '推理執行環境或所選後端不可用',
      'inferenceSessionWaitingForModel': '等待模型下載並通過校驗',
      'inferenceSessionNotTested': '尚未建立，將在首次推理時驗證',
      'inferenceSessionReady': '已成功建立，可以執行推理',
      'inferenceSessionFailed': '最近一次建立失敗，請查看日誌或更換後端',
      'inferenceFrameworkNote': '執行提供器、模型完整性和 Session 狀態分別偵測。',
      'inferenceBackendAuto': '自動',
      ...
      'superResolutionEngineOnnx': 'ONNX（應用內建）',
      ...
      'onnxModelDescRealEsrgan6B': '高精度檔：細節最豐富、畫質最好，速度較慢。',
      'onnxModelDescRealEsrgan4B32F': '快速檔：約快 3-4 倍，細節略少，適合批次處理。',
      'superResolutionModelPickerHint': '切換模型後，已完成的高解析度頁面需重新處理',
      ...
      'imageTimeoutRetry': '逾時重試',
      'imageTimeoutRetryHint': '線上圖片沒有回應或載入進度卡住時自動重試',
      'imageTimeoutRetryCount': '重試次數',
      'imageTimeoutRetryInterval': '逾時判定',
...
favnote：配對收藏備註
    ...
    ''',
      ...
      'configure': '設定',
      'saveSetting': '儲存',
      'imageTranslationNoResult': '沒有可顯示的結果',
      'imageTranslationConfigureHint': '已辨識原文。請先在進階設定中設定翻譯服務。',
      'imageTranslationUnsupportedPlatform': '目前平台尚未支援圖片 OCR。',
      'imageTranslationOcrUnavailable': '找不到 OCR 程式。桌面端請安裝或設定 Tesseract。',
      'imageTranslationOcrFailed': '文字辨識失敗，請檢查 OCR 語言包和圖片格式。',
      'imageTranslationNoText': '未在圖片中辨識到文字。',
      'imageTranslationAlreadyTranslated': '該頁已翻譯。',
      'imageTranslationCancelled': '翻譯已取消。',
      ...
      'translationStageRecognizing': '正在辨識',
      'translationStageTranslating': '正在翻譯',
      'translationStageMasking': '正在遮罩',
      'translationStageEmbedding': '正在嵌字',
      'translationStageDone': '完成',
      'imageTranslationSourceUnavailable': '無法取得目前圖片。',
      'imageTranslationSettingHint': '設定 OCR 與翻譯服務',
      'imageTranslationOcrSection': '文字辨識',
      'imageTranslationOcrHint': '桌面端預設呼叫本機 Tesseract，請安裝所需語言包。',
      ...
      'imageTranslationApiTestHint': '填寫 API 根網址和金鑰後，測試並讀取可用模型。金鑰只會保存在本機。',
      'imageTranslationProvider': 'API 格式',
      'imageTranslationOpenAICompatible': 'OpenAI 相容格式',
      'imageTranslationApiBaseUrl': 'API 根網址',
      'imageTranslationTestAndFetchModels': '測試並取得模型',
      ...
      'imageTranslationOcrModelSource': 'OCR 模型來源',
      'imageTranslationGiteeMirror': 'Gitee 社群鏡像（中國）',
      'imageTranslationGithubOfficial': 'GitHub 官方來源',
      'imageTranslationOcrInstalled': '已安裝',
      'imageTranslationOcrNotInstalled': '未安裝',
      'imageTranslationOcrDetectFailed': 'OCR 偵測失敗，請檢查可執行檔路徑。',
