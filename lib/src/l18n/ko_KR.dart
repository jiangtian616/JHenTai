...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'autoRetryCountHint': '-1로 설정하면 무한 재시도, 0으로 설정하면 비활성화, 최대값은 10',
      'retryDelay': '재시도 지연 시간',
      'retryDelayHint': '0으로 설정하면 지연 없음, 최대값은 3000ms',
      'retrying': '재시도 중',
      'longPress2Reset': '길게 눌러 재설정',
      'resetSuccess': '재설정 성공',
      'imageConnectionTimeout': '이미지 연결 시간 초과',
      'imageConnectionTimeoutHint': '이미지 로딩 연결 설정 시간 초과, 길게 눌러 기본값으로 재설정',
      'imageMaxConnectionsPerHost': '이미지 최대 연결 수',
      'imageMaxConnectionsPerHostHint': '호스트당 최대 동시 연결 수로 풀 오염 방지, 길게 눌러 기본값으로 재설정',
      'imageIdleTimeout': '이미지 유휴 연결 시간 초과',
      'imageIdleTimeoutHint': '유휴 연결 자동 종료 시간으로 문제 있는 연결 정리, 길게 눌러 기본값으로 재설정',
