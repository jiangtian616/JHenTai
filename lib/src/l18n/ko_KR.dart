...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      'smartCacheEvictByAddedDate': "추가 날짜순",
      'smartCacheEvictByUsageFrequency': "사용 빈도순",
      'unlimited': "무제한",
      'cacheSize': "현재 캐시 크기",
      'oneMinute': '1분',
      'tenMinute': '10분',
      ...
      'inferenceRefresh': '새로고침',
      'inferenceModeSection': '모드',
      'inferenceManualSection': '백엔드 수동 지정',
      'inferenceDetectionSection': '감지 결과',
      'inferenceModelSection': '모델 연동 상태',
      'inferenceModeAuto': '자동 감지',
      'inferenceModeManual': '수동 지정',
      'inferenceModeCpu': 'CPU 강제',
      'inferencePreferredBackend': '선호 백엔드',
      ...
      'inferenceModelInvalid': '모델이 손상되었거나 검증에 실패했습니다. 다시 다운로드하세요',
      'inferenceSessionStatus': 'Session 상태',
      'inferenceSessionBackendUnavailable': '추론 런타임 또는 선택한 백엔드를 사용할 수 없음',
      'inferenceSessionWaitingForModel': '다운로드 및 검증된 모델을 기다리는 중',
      'inferenceSessionNotTested': '아직 생성되지 않았으며 첫 추론 시 확인됩니다',
      'inferenceSessionReady': '성공적으로 생성되어 추론 가능',
      'inferenceSessionFailed': '최근 생성 실패. 로그를 확인하거나 백엔드를 변경하세요',
      'inferenceFrameworkNote': '실행 제공자, 모델 무결성 및 Session 상태를 별도로 감지합니다.',
      'inferenceBackendAuto': '자동',
      ...
      'imageTimeoutRetry': '시간 초과 재시도',
      'imageTimeoutRetryHint': '온라인 이미지가 응답하지 않거나 진행이 멈추면 자동 재시도합니다',
      'imageTimeoutRetryCount': '재시도 횟수',
      'imageTimeoutRetryInterval': '시간 초과 기준',
...
Example 2: Block comments with a score not exceeding 10————Comment Score <= 10
    ''',
      ...
      'imageTranslationCancelled': '번역이 취소되었습니다.',
      ...
      'imageTranslationTestAndFetchModels': '테스트 및 모델 가져오기',
      ...
      'imageTranslationOcrModelSource': 'OCR 모델 소스',
      'imageTranslationGiteeMirror': 'Gitee 커뮤니티 미러 (중국)',
      'imageTranslationGithubOfficial': 'GitHub 공식 소스',
      'imageTranslationOcrInstalled': '설치됨',
      'imageTranslationOcrNotInstalled': '설치되지 않음',
      'imageTranslationOcrDetectFailed': 'OCR 감지 실패. 실행 파일 경로를 확인하세요.',
