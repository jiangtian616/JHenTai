...
class ko_KR {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': '로컬',
      'scanCompleted': '로컬 갤러리 스캔 완료',
      'deleteHistoryVersions': '이전 버전 삭제',
      'deleteHistoryVersionsHint': '이름이 아닌 버전 체인(oldVersionGalleryUrl)으로 그룹화합니다. 심층 스캔으로 원격 링크를 찾을 수 있습니다.',
      'deletingHistoryVersions': '이전 버전 삭제 중',
      'deletingHistoryVersionsInProgress': '이전 버전 삭제 중, 잠시만 기다려주세요',
      'deleteHistoryVersionsCompleted': '이전 버전 삭제 완료',
      'noHistoryVersionsToDelete': '삭제할 이전 버전이 없습니다',
      'scanningHistoryVersions': '이전 버전 스캔 중',
      'deepScan': '심층 스캔',
      'deepScanning': '원격 갤러리 심층 스캔 중...',
      'deepScanCompleted': '심층 스캔 완료, 새 링크 \$n개 발견',
      'deepScanNoNewLinks': '심층 스캔 완료, 새 버전 링크 없음',
      'noGalleriesToDeepScan': '심층 스캔할 갤러리 없음',
      'versions': '버전',
      'ungroupedGalleriesHint': '개 미분류 갤러리, 심층 스캔을 눌러 확인',
      'linkedVersion': '연결됨',
      'retryFailed': '실패 항목 재시도',
      'failedGallerys': '실패한 갤러리',
      'useHistoryScanResult': '이전 스캔 결과 사용',
      'newDeepScan': '새 심층 스캔',
      'deepScanChoiceHint': '24시간 이내의 이전 스캔 결과가 있습니다.',
      'failedCount': '실패',
      'selectAll': '전체 선택',
      'deselectAll': '전체 해제',
      'selected': '선택됨',
      ...
      'pages': '페이지',
      'scanFailed': '스캔 실패',
      'batchDownloadInProgress': '일괄 다운로드 진행 중, 잠시만 기다려주세요',
      'noNewFavoritesToDownload': '다운로드할 새 즐겨찾기 없음',
      'batchDownloadCompleted': '일괄 다운로드 완료',
      'loadingAllFavorites': '모든 즐겨찾기 로딩 중',
      'batchDownloading': '일괄 다운로드 중',
      'batchDownloadRetryExhausted': '재시도 횟수 소진',
      'batchDownloadLoadingFailed': '즐겨찾기 로딩 실패, 진행 상황 저장됨',
      'batchDownloadFailureCountdown': '다운로드 실패, \$time 내에 다시 클릭하여 계속',
      'interruptWait': '대기 중단',
      'batchDownloadResumed': '중단된 다운로드 재개',
      'batchDownloadWaitInterrupted': '대기 중단됨, 다음에 새로 시작',
      'reDownload': '다시 다운로드',
      'delete': '삭제',
