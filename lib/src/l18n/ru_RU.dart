...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      /// download page
      'local': 'Локально',
      'scanCompleted': 'Сканирование локальных галерей завершено',
      'deleteHistoryVersions': 'Удалить предыдущие версии',
      'deleteHistoryVersionsHint': 'Группировка по цепочке версий (oldVersionGalleryUrl), а не по названию. Используйте глубокое сканирование для поиска удалённых связей.',
      'deletingHistoryVersions': 'Удаление предыдущих версий',
      'deletingHistoryVersionsInProgress': 'Удаление предыдущих версий, подождите',
      'deleteHistoryVersionsCompleted': 'Удаление предыдущих версий завершено',
      'noHistoryVersionsToDelete': 'Нет предыдущих версий для удаления',
      'scanningHistoryVersions': 'Сканирование предыдущих версий',
      'deepScan': 'Глубокое сканирование',
      'deepScanning': 'Глубокое сканирование удалённых галерей...',
      'deepScanCompleted': 'Глубокое сканирование завершено, найдено \$n новых связей',
      'deepScanNoNewLinks': 'Глубокое сканирование завершено, новых связей не найдено',
      'noGalleriesToDeepScan': 'Нет галерей для глубокого сканирования',
      'versions': 'версий',
      'ungroupedGalleriesHint': 'несгруппированных галерей, нажмите для глубокой проверки',
      'linkedVersion': 'связан',
      'retryFailed': 'Повторить неудачные',
      'failedGallerys': 'Ошибки галерей',
      'useHistoryScanResult': 'Использовать предыдущий результат',
      'newDeepScan': 'Новое сканирование',
      'deepScanChoiceHint': 'Доступен результат предыдущего сканирования за последние 24 часа.',
      'failedCount': 'ошибок',
      ...
      'batchDownloadInProgress': 'Пакетная загрузка выполняется, подождите',
      'noNewFavoritesToDownload': 'Нет новых избранных для загрузки',
      'batchDownloadCompleted': 'Пакетная загрузка завершена',
      'loadingAllFavorites': 'Загрузка всех избранных',
      'batchDownloading': 'Пакетная загрузка',
      'batchDownloadRetryExhausted': 'Попытки исчерпаны',
      'batchDownloadLoadingFailed': 'Не удалось загрузить избранные, прогресс сохранён',
      'batchDownloadFailureCountdown': 'Загрузка не удалась, повторите в течение \$time',
      'interruptWait': 'Прервать ожидание',
      'batchDownloadResumed': 'Возобновление прерванной загрузки',
      'batchDownloadWaitInterrupted': 'Ожидание прервано, в следующий раз начнётся заново',
