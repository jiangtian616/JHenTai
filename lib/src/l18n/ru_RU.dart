...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'useWebview': 'Использовать Webview',
      'skipCookieVerification': 'Пропустить проверку',
      ...
      'cloudflare403': 'Cloudflare заблокировал сетевые запросы. Попробуйте переключить сеть или использовать другой способ входа.',
      ...
      'blankImageHint': 'Загрузка изображения вернула пустой результат, выполняется повторный разбор.',
      ...
      'useJH2UpdateGallery': 'Использовать сервер JH для ускорения обновления галерей',

      /// archive bot settings
      'archiveBotSettings': 'Настройки Archive Bot',
      'archiveBotSettingsHint': 'Использовать Archive Bot для получения ссылок на архивы бесплатно',
      'apiSetting': 'Настройки API',
      'apiAddress': 'Адрес',
      'apiKey': 'Ключ',
      'apiKeyHint': 'Введите ключ, полученный от бота в Telegram',
      'dailyCheckin': 'Ежедневная регистрация',
      'currentBalance': 'Текущий баланс GP',
      'checkBalanceFailed': 'Не удалось получить баланс GP',
      'checkInFailed': 'Ошибка регистрации',
      'checkInSuccess': 'Регистрация прошла успешно',
      'checkInSuccessHint': 'Получено GP: %s, текущий итоговый GP: %s.',
      'pauseDownloadByInvalidArchiveBotKey': 'Настройки Archive Bot недействительны, загрузка приостановлена',
      'chooseArchiveParseSource': 'Изменить источник разбора',
      'official': 'Официальный',
      'archiveBot': 'Archive Bot',
      'changeParseSource2Official': 'Изменить источник разбора на официальный',
      'changeParseSource2Bot': 'Изменить источник разбора на Archive Bot',
      'invalidParam': 'Недопустимый параметр',
      'invalidApiKey': 'Недействительный ключ API',
      'banned': 'Вы были заблокированы',
      'fetchGalleryInfoFailed': 'Не удалось получить информацию о галерее',
      'insufficientGP': 'Недостаточно GP',
      'parseFailed': 'Ошибка разбора',
      'checkedIn': 'Регистрация за сегодня уже выполнена',
      'serverError': 'Внутренняя ошибка Archive Bot',
      'useProxyServer': 'Использовать прокси-сервер JHenTai',
      'useProxyServerHint': 'Маршрутизировать запросы через сервер JHenTai',
