...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'longPressDuration': 'Длительность длинного нажатия',
      'longPressDurationHint': 'Время удержания для срабатывания длинного нажатия, нажмите и удерживайте для сброса',
