...
class ru_RU {
  static Map<String, String> keys() {
    return {
      ...
      'autoRetryCountHint': 'Установите -1 для бесконечных повторных попыток, 0 для отключения, максимальное значение 10',
      'retryDelay': 'Задержка между повторными попытками',
      'retryDelayHint': 'Установите 0 для отсутствия задержки, максимальное значение 3000мс',
      'retrying': 'Повторная попытка',
      'longPress2Reset': 'Нажмите и удерживайте для сброса',
      'resetSuccess': 'Сброс выполнен успешно',
      'imageConnectionTimeout': 'Тайм-аут подключения изображения',
      'imageConnectionTimeoutHint': 'Тайм-аут установки подключения для загрузки изображений, нажмите и удерживайте для сброса',
      'imageMaxConnectionsPerHost': 'Макс. подключений для изображений',
      'imageMaxConnectionsPerHostHint': 'Макс. одновременных подключений на хост для предотвращения загрязнения пула, нажмите и удерживайте для сброса',
      'imageIdleTimeout': 'Тайм-аут простоя подключений',
      'imageIdleTimeoutHint': 'Время автоматического закрытия неактивных подключений для очистки проблемных соединений, нажмите и удерживайте для сброса',
