...
@Deprecated('Replaced by ArchiveDownloadService')
class OldArchiveDownloadService extends GetxController {
  ...
  static void init() {
    ...
    Get.put(OldArchiveDownloadService(), permanent: true);
  }
  ...
  Future<void> resumeDownloadArchive(int gid, bool isOriginal) async {
    ...
    archive = archive.copyWith(
      archiveStatusIndex: archive.downloadPageUrl == null
          ? ArchiveStatus.parsingDownloadPageUrl.index
  ...
  Future<String?> _requestUnlock(ArchiveDownloadedData archive) async {
    ...
    if (downloadPageUrl == null) {
      _updateArchive(archive.copyWith(archiveStatusIndex: ArchiveStatus.parsingDownloadPageUrl.index));
    } else {
      Log.info('Unlock archive success: ${archive.gid}');
      _updateArchive(archive.copyWith(archiveStatusIndex: ArchiveStatus.parsingDownloadUrl.index, downloadPageUrl: downloadPageUrl));
    }
  ...
  Future<String> _getDownloadUrl(ArchiveDownloadedData archive, String downloadPageUrl) async {
    ...
    archive = archive.copyWith(archiveStatusIndex: ArchiveStatus.parsingDownloadUrl.index);
    _updateArchive(archive);
