...
class EhPageView extends StatefulWidget {
  ...
  /// A delegate that provides the children for the [EhPageView].
  ///
  /// The [PageView.custom] constructor lets you specify this delegate
  /// explicitly. The [EhPageView] and [PageView.builder] constructors create a
  ...
  @override
  State<EhPageView> createState() => _EhPageViewState();
}

class _EhPageViewState extends State<EhPageView> {
