...
import '../pages/setting/download/aria2/aria2_settings_page.dart';
...
class Routes {
  ...
  static const String aria2Settings = '/setting/download/aria2';
  ...
  static List<EHPage> pages = <EHPage>[
    ...
    EHPage(
      name: aria2Settings,
      page: () => const Aria2SettingsPage().withEscOrFifthButton2BackRightRoute(),
      transition: defaultTransition,
      offAllBefore: false,
    ),
    EHPage(
