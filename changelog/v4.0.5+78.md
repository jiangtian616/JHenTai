...
5. 增加点赞时的数字动画
6. 修复Webview的bug
7. 修复Windows系统下当你设置下载路径为根路径，如I:\时发生的bug。（不推荐下载路径设置为根路径）
8. 修复识别图片名的bug
...
6. Fix bug with Webview.
7. Fix bug when you set download path at root path like I:\ on Windows
8. Fix bug with image reorganization