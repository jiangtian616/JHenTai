...
4. 优化使用多标签搜索时的搜索历史纪录
5. 修复Webview的bug
6. 修复Windows系统下当你设置下载路径为根路径，如I:\时发生的bug。（不推荐下载路径设置为根路径）
7. 修复识别图片名的bug
...
5. Fix bug with Webview.
6. Fix bug when you set download path at root path like I:\ on Windows
7. Fix bug with image reorganization